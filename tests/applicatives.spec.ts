...
describe('Applicatives', () => {
  test.todo('Write a function that adds two possibly null numbers together using `Option.ap`.', () => {
    expect(safeAdd(2, 3)).toEqual(Option.some(5))
    expect(safeAdd(null, 3)).toEqual(Option.none())
  })

  test.todo('Now write a function that takes 2 Option parameters and adds them. Use `Option.zipWith`.', () => {
  ...
  test.todo('Now write a function that takes 2 Option parameters and adds them. Use `Option.lift2`.', () => {
  ...
  test.todo('Run both `getPost` and `getComments` then render the page with both.', async () => {
  ...
  test.todo('Do the same thing as above but now render all posts using `Effect.all`.', async () => {
  ...
  test.todo('Do the same thing as above but now using generator syntax!', async () => {
  ...
  test.todo('Write an Effect that gets both player1 and player2 from the cache and starts the game.', () => {

...
describe('Functors', () => {
  ...
  test.todo('Write a validation function that checks for a length > 3.', () => {
    expect(validateName('hello')).toEqual(Result.succeed('hello'))
    expect(validateName('fla')).toEqual(Result.fail('You need > 3'))
  })

  test.todo('Use `validateName` above and Either/Effect to save the user or return the error message.', () => {
